<template>
    <DropdownMenu>
        <DropdownMenuTrigger>
            <Button variant="outline" size="icon" title="数据处理">
        ...
        <DropdownMenuContent>
            <DropdownMenuLabel>数据处理</DropdownMenuLabel>
            <DropdownMenuSeparator />
            <DropdownMenuItem>导出数据</DropdownMenuItem>
            <DropdownMenuItem>导入数据</DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem>清除所有数据</DropdownMenuItem>
        </DropdownMenuContent>
    </DropdownMenu>
</template>

<script setup lang="ts" name="dataProcessing">
